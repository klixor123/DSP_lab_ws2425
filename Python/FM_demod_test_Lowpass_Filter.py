...
output_file = "C:\\Users\\ludwi\\Documents\\H_KA_Studium\\0IB6_Digitale_Signalprozessoren\\DSP_FM_Demod_VSC\\Python\\demodulated_audio_filtered.wav"
...
# FM-Demodulation
def fm_demodulate(signal, carrier_freq, sr):
    # Differenz der Phasen (Hilbert-Differenz)
    analytic_signal = np.angle(signal[1:] * np.conj(signal[:-1]))
...
# FM-Demodulation
carrier_freq = 7000  # Trägerfrequenz
demodulated_signal = fm_demodulate(fm_signal, carrier_freq, sr)
